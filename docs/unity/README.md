...
- если это тайлы: `Pixel Per Unit`, например ставить 16 (размер тайла **16x16**)
...
- можно сделать пресеты для разных режимов импорта
...
- с помощью 1 GO с [Sprite Renderer](https://docs.unity3d.com/6000.3/Documentation/Manual/sprite/renderer/sprite-renderer-reference.html), в режиме `Draw Mode.Tiled`, можно покрыть сеткой большую площадь (в настройках импорта спрайта поставить `Mesh Type.Full Rect`)
