...
Требуются пакеты для работы: `Unity Test Framework`, [NaughtyAttributes](https://openupm.com/packages/com.dbrizov.naughtyattributes), [Unity-SerializeReferenceExtensions](https://openupm.com/packages/com.mackysoft.serializereference-extensions)
...
- таймер: `DownTimer`
    ...
    - состояние: простой(`None`), запущенный (`Playing`), пауза(`Paused`) и завершённый(`Completed`)
- кулдаун: `Cooldown`
